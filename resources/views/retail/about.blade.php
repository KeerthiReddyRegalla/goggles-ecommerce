                    ...
                    <div class="row mt-lg-5 mt-3">
                        <div class="col-md-3 team-main-gd">
                            <div class="team-grid text-center">
                                <div class="team-img">
                                    <img class="img-fluid rounded" src="{{ asset('assets/images/team1.jpg') }}" alt="">
                                </div>
                                <div class="team-info">
                                    <h4>Partner 1</h4>
                        ...
                        <div class="col-md-3 team-main-gd">
                            <div class="team-grid text-center">
                                <div class="team-img">
                                    <img class="img-fluid rounded" src="{{ asset('assets/images/team2.jpg') }}" alt="">
                                </div>
                                <div class="team-info">
                                    <h4>Partner 2</h4>
                                    <span>Description </span>
                        ...
                        <div class="col-md-3 team-main-gd">
                            <div class="team-grid text-center">
                                <div class="team-img">
                                    <img class="img-fluid rounded" src="{{ asset('assets/images/team3.jpg') }}" alt="">
                                </div>
                                <div class="team-info">
                                    <h4>Partner 3</h4>
                                    <span>Description </span>
                        ...
                        <div class="col-md-3 team-main-gd">
                            <div class="team-grid text-center">
                                <div class="team-img">
                                    <img class="img-fluid rounded" src="{{ asset('assets/images/team4.jpg') }}" alt="">
                                </div>
                                <div class="team-info">
                                    <h4>Partner 4</h4>
                                    <span>Description </span>
