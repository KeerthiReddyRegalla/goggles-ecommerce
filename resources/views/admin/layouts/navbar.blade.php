        ...
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-brand d-xl-none">
                <a href="/demo2/index.html" class="logo-link">
                    <img class="logo-light logo-img" src="/demo2/images/logo.png" srcset="/demo2/images/logo2x.png 2x" alt="logo" />
                    <img class="logo-dark logo-img" src="/demo2/images/logo-dark.png" srcset="/demo2/images/logo-dark2x.png 2x" alt="logo-dark" />
                </a>
            </div>
                    ...
                    <li class="dropdown user-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end">
                            ...
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    <li>
                                        <a href="/demo2/lms/admin-profile.html"><em class="icon ni ni-user-alt"></em><span>View Profile</span></a>
                                    </li>
                                    <li>
                            ...
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    <li>
                                        <a href="{{ route('login') }}"><em class="icon ni ni-signout"></em><span>Sign out</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
