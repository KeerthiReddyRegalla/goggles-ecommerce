                    ...
                    <div class="row">
                        <div class="col-md-10 offset-md-1">
                            ...
                            <div class="my-5 text-center text-lg-start">
                                <h1 class="display-8">Verify TOTP Code</h1>
                            ...
                            @endif
                            <form class="mb-5" method="post" action="/two-factor-challenge">
                                @csrf
                                <div class="mb-3">
                                    <input type="password" class="form-control" placeholder="Enter code" name="code"
                                           required>
                                </div>
